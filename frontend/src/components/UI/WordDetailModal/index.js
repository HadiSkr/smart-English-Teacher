        ...
        <div className={classes.content}>
          ...
          {level !== '0' && (
            <p className={classes.level}>
              <b className={classes.label}>Level:</b>&nbsp;&nbsp;
              {level}
            </p>
          )}
          {examples && examples.length > 0 && (
            <div>
              <b className={classes.label}>Example sentence:</b>
          ...
          {specialty && specialty !== '0' && (
            <p>
              <b className={classes.label}>Specialized in:</b>
              &nbsp;&nbsp;
          ...
          {topics && topics.length > 0 && (
            <>
              <b className={classes.label}>Topic:</b>
          ...
          {synonyms && synonyms.length > 0 && (
            <p>
              <b className={classes.label}>Synonyms:</b>&nbsp;&nbsp;
              {synonyms.join(', ')}
            </p>
          )}
          ...
          {antonyms && antonyms.length > 0 && (
            <p>
              <b className={classes.label}>Antonyms:</b>&nbsp;&nbsp;
              {antonyms.join(', ')}
            </p>
          )}
          ...
          {note && note !== '' && (
            <>
              <b className={classes.label}>Note:</b>
              <p>
                {note.split('\n').map((i, index) => (
                  <span key={index}>
                    {i} <br />
