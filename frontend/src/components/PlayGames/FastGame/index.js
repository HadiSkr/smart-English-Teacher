...
function Result({ score }) {
  ...
  return (
    <div className="w-100 h-100 flex-center flex-dir-col">
      <h2 className={classes.doneTitle}>End</h2>
      <div className={classes.doneResult}>Your score is: {score}</div>
      <div className="mt-10">
        <Button
      ...
      {!isDone ? (
        <>
          <div>
            <div className="english-game-title">
              ...
              <h1>
                ...
                <TooltipCustom
                  ...
                  title={`Choose the picture that matches the meaning of the word. Choose false -${WRONG_SCORE}, true +${CORRECT_SCORE}. Points will be added to your remaining time.`}
                >
                  <HelpIcon />
                </TooltipCustom>
              </h1>
            ...
            Sentence&nbsp;<b>{currentIndex.current + 1}</b>&nbsp;/&nbsp;
              <b>{list.length}</b>
              &nbsp;- Point:&nbsp;<b>{score}</b>
            </p>
